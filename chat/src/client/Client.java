...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Danh sach online ", jPanel1);
        ...
        jLabel1.setText("Chon nguoi nhan");

        jLabel2.setText("Nhap tin nhan");
        ...
        jTabbedPane1.addTab("Nhan tin", jPanel2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBox1.getSelectedIndex()==0){
            try {
                ...
                jTextArea1.setText(jTextArea1.getText()+"Ban: "+messageContent+"\n");
            ...
            try {
                ...
                jTextArea1.setText(jTextArea1.getText()+"Ban (Toi:Client "+parner[1]+"): "+messageContent+"\n");
                jTextArea1.setCaretPosition(jTextArea1.getDocument().getLength());
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        if(jComboBox1.getSelectedIndex()==0){
            ...
            jLabel3.setText("Dang nhan voi »›i "+jComboBox1.getSelectedItem());
        }
                        ...
                        while (true) {
                            ...
                            if (messageSplit[0].equals("update-online-list")) {
                                ...
                                for(int i=0; i<onlineSplit.length; i++){
                                    ...
                                    online+="Nguoi dung "+onlineSplit[i]+" Dang hoat dong\n";
                                }
